...
FUNC(Std_ReturnType,FRIF_CODE) FrIf_GetChannelStatus
    (
        uint8 FrIf_CtrlIdx,
    ...
    )
{
    ...
    DBG_FRIF_GETCHANNELSTATUS_ENTRY(FrIf_CtrlIdx,FrIf_ChannelAStatusPtr,FrIf_ChannelBStatusPtr);
...
/* check if development error detection is disabled */
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_GETCHANNELSTATUS_SERVICE_ID, FRIF_E_NOT_INITIALIZED);
    }
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_GETCHANNELSTATUS_SERVICE_ID, FRIF_E_INV_CTRL_IDX);
    }
...
#endif  /* FRIF_DEV_ERROR_DETECT == STD_OFF */
    {
        ...
        RetValue = FrIf_Call_Fr_Arg3(FRIF_FR_INSTANCE_IDX,GetChannelStatus,FRIF_FR_CTRLIDX, FrIf_ChannelAStatusPtr, FrIf_ChannelBStatusPtr);
    }

    /* return result */

    DBG_FRIF_GETCHANNELSTATUS_EXIT(RetValue,FrIf_CtrlIdx,FrIf_ChannelAStatusPtr,FrIf_ChannelBStatusPtr);
    return RetValue;
}
