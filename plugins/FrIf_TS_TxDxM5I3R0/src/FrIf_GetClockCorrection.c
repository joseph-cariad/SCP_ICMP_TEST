...
FUNC(Std_ReturnType,FRIF_CODE) FrIf_GetClockCorrection
    (
        uint8 FrIf_CtrlIdx,
    ...
    )
{
    ...
    DBG_FRIF_GETCLOCKCORRECTION_ENTRY(FrIf_CtrlIdx,FrIf_RateCorrectionPtr,FrIf_OffsetCorrectionPtr);
...
/* check if development error detection is disabled */
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_GETCLOCKCORRECTION_SERVICE_ID, FRIF_E_NOT_INITIALIZED);
    }
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_GETCLOCKCORRECTION_SERVICE_ID, FRIF_E_INV_CTRL_IDX);
    }
...
#endif  /* FRIF_DEV_ERROR_DETECT == STD_OFF */
    {
        ...
        RetValue = FrIf_Call_Fr_Arg3(FRIF_FR_INSTANCE_IDX,GetClockCorrection,FRIF_FR_CTRLIDX, FrIf_RateCorrectionPtr, FrIf_OffsetCorrectionPtr);
    }

    /* return result */

    DBG_FRIF_GETCLOCKCORRECTION_EXIT(RetValue,FrIf_CtrlIdx,FrIf_RateCorrectionPtr,FrIf_OffsetCorrectionPtr);
    return RetValue;
}
