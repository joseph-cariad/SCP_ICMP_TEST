    ...
    )
{
    ...
    DBG_FRIF_DISABLETRANSCEIVERBRANCH_ENTRY(FrIf_CtrlIdx,FrIf_ChnlIdx,FrIf_BranchIdx);
...
/* check if development error detection is disabled */
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_DISABLETRANSCEIVERBRANCH_SERVICE_ID, FRIF_E_NOT_INITIALIZED);
    }
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_DISABLETRANSCEIVERBRANCH_SERVICE_ID, FRIF_E_INV_CTRL_IDX);
    }
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_DISABLETRANSCEIVERBRANCH_SERVICE_ID, FRIF_E_INV_CHNL_IDX);
    }
...
#endif  /* FRIF_DEV_ERROR_DETECT == STD_OFF */
    {
        ...
        if((FRIF_FRTRCV_INSTANCE_IDX != FRIF_INVALID_ENTRY) &&
           (FrIf_Get_FrTrcvFunctionPtr(FRIF_FRTRCV_INSTANCE_IDX,DisableTransceiverBranch) != NULL_PTR))

#endif /* FRIF_SINGLE_FRTRCV_OPT_ENABLE */
        {
            /* call wrapped FrTrcv service */
            RetValue = FrIf_Call_FrTrcv(FRIF_FRTRCV_INSTANCE_IDX,DisableTransceiverBranch)(
    ...
    DBG_FRIF_DISABLETRANSCEIVERBRANCH_EXIT(RetValue,FrIf_CtrlIdx,FrIf_ChnlIdx,FrIf_BranchIdx);
    return RetValue;
}
