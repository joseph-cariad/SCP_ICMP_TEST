 ...
 * \param FrIf_ChnlIdx (in)       Channel the MTS should be transmitted on.
 *
...
FUNC(Std_ReturnType,FRIF_CODE) FrIf_SendMTS
    (
        uint8 FrIf_CtrlIdx,
    ...
    )
{
    ...
    DBG_FRIF_SENDMTS_ENTRY(FrIf_CtrlIdx,FrIf_ChnlIdx);
...
/* check if development error detection is disabled */
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_SENDMTS_SERVICE_ID, FRIF_E_NOT_INITIALIZED);
    }
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_SENDMTS_SERVICE_ID, FRIF_E_INV_CTRL_IDX);
    }
...

    {
        ...
        RetValue = FrIf_Call_Fr_Arg2(FRIF_FR_INSTANCE_IDX,SendMTS,FRIF_FR_CTRLIDX, FrIf_ChnlIdx);
    }

    /* return result */

    DBG_FRIF_SENDMTS_EXIT(RetValue,FrIf_CtrlIdx,FrIf_ChnlIdx);
    return RetValue;
}
...
FUNC(Std_ReturnType,FRIF_CODE) FrIf_StopMTS
    (
        uint8 FrIf_CtrlIdx,
        Fr_ChannelType FrIf_ChnlIdx
    )
{
    ...
    DBG_FRIF_STOPMTS_ENTRY(FrIf_CtrlIdx,FrIf_ChnlIdx);
...
/* check if development error detection is disabled */
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_STOPMTS_SERVICE_ID, FRIF_E_NOT_INITIALIZED);
    }
    ...
    {
        /* Report to DET */
        FrIf_Det_ReportError(FRIF_STOPMTS_SERVICE_ID, FRIF_E_INV_CTRL_IDX);
    }
    ...
    {
        /* call wrapped Fr service */
        RetValue = FrIf_Call_Fr_Arg2(FRIF_FR_INSTANCE_IDX,StopMTS,FRIF_FR_CTRLIDX, FrIf_ChnlIdx);
    }

    /* return result */

    DBG_FRIF_STOPMTS_EXIT(RetValue,FrIf_CtrlIdx,FrIf_ChnlIdx);
    return RetValue;
}
