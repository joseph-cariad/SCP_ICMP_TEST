 ...
 */
#ifndef TCPIP_IPV4_API_H
#define TCPIP_IPV4_API_H
...
/** \brief Specifies an entry in the ARP cache */
typedef struct
{
...
/** \brief Retrieve all valid physical addresses from ARP cache
 *
 * This service copies entries from the physical address cache of the IPv4 instance that is active
 ...
 * \retval E_NOT_OK  physical address cache could not be read (i.e. no IPv4 instance active on
 *                   this controller)
 *
 * \ServiceID{0x1d}
