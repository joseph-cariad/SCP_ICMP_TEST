...
/* @} *//* End of macros definitions for Dcm_SesCtrlType */

#if (DCM_APPL_TXCONFIRMATION_NOTIFICATION == STD_ON)
/** @defgroup Macro_Dcm_ResponseConfirmationTypeType Macros for Dcm_ResponseConfirmationTypeType
 ** \brief    These macros are used as values for Dcm_ResponseConfirmationTypeType
 **  @{
 */

#if (defined DCM_FINALRESPONSE)
#error DCM_FINALRESPONSE already defined
#endif/* #if (defined DCM_FINALRESPONSE) */

/** \brief  */
#define DCM_FINALRESPONSE 0X00U


#if (defined DCM_FORCED_RCRRP)
#error DCM_FORCED_RCRRP already defined
#endif/* #if (defined DCM_FORCED_RCRRP) */

/** \brief   */
#define DCM_FORCED_RCRRP 0X01U


#if (defined DCM_TIMEOUT_RCRRP)
#error DCM_TIMEOUT_RCRRP already defined
#endif/* #if (defined DCM_TIMEOUT_RCRRP) */

/** \brief   */
#define DCM_TIMEOUT_RCRRP 0X02U
/* @} *//* End of macros definitions for Dcm_ResponseConfirmationTypeType */
...
#if (DCM_RTETYPES_PROTECTION_AT_FILE_LEVEL == STD_ON)
#if (DCM_INCLUDE_RTE == STD_OFF)
...
#endif /* #if (DCM_INCLUDE_RTE == STD_OFF) */
#else /* #if (DCM_RTETYPES_PROTECTION_AT_FILE_LEVEL == STD_ON) */
...
#ifndef RTE_TYPE_Dcm_DTRStatusType
#define RTE_TYPE_Dcm_DTRStatusType
/** \brief Type used for providing the status of DTR's */
typedef uint8 Dcm_DTRStatusType;
#endif /* ifndef RTE_TYPE_Dcm_DTRStatusType */
#endif /* #if (DCM_RTETYPES_PROTECTION_AT_FILE_LEVEL == STD_ON) */
...
typedef P2VAR(Dcm_MsgItemType, TYPEDEF, DCM_VAR) Dcm_MsgType;
...
typedef struct
{
   ...
   **        - 4 = PostBoot response request with no answer
   **        - 5 = PostBoot response request with answer
   */
  unsigned int requestOrigin:3;
}
Dcm_MsgAddInfoType;
