...
#if (defined E2EP05_VENDOR_ID) /* to prevent double declaration */
#error E2EP05_VENDOR_ID is already defined
#endif
/** \brief AUTOSAR vendor identification: Elektrobit Automotive GmbH */
#define E2EP05_VENDOR_ID         1U

/*------------------[AUTOSAR release version identification]----------------*/

#if (defined E2EP05_AR_RELEASE_MAJOR_VERSION) /* to prevent double declaration */
#error E2EP05_AR_RELEASE_MAJOR_VERSION already defined
#endif
/** \brief AUTOSAR release major version */
#define E2EP05_AR_RELEASE_MAJOR_VERSION  4U

#if (defined E2EP05_AR_RELEASE_MINOR_VERSION) /* to prevent double declaration */
#error E2EP05_AR_RELEASE_MINOR_VERSION already defined
#endif
/** \brief AUTOSAR release minor version */
#define E2EP05_AR_RELEASE_MINOR_VERSION  2U

#if (defined E2EP05_AR_RELEASE_REVISION_VERSION) /* to prevent double declaration */
#error E2EP05_AR_RELEASE_REVISION_VERSION already defined
#endif
/** \brief AUTOSAR release revision version */
#define E2EP05_AR_RELEASE_REVISION_VERSION  1U

/*------------------[AUTOSAR module version identification]------------------*/

#if (defined E2EP05_SW_MAJOR_VERSION) /* to prevent double declaration */
#error E2EP05_SW_MAJOR_VERSION already defined
#endif
/** \brief AUTOSAR module major version */
#define E2EP05_SW_MAJOR_VERSION  1U

#if (defined E2EP05_SW_MINOR_VERSION) /* to prevent double declaration */
#error E2EP05_SW_MINOR_VERSION already defined
#endif
/** \brief AUTOSAR module minor version */
#define E2EP05_SW_MINOR_VERSION  0U

#if (defined E2EP05_SW_PATCH_VERSION) /* to prevent double declaration */
#error E2EP05_SW_PATCH_VERSION already defined
#endif
/** \brief AUTOSAR module patch version */
#define E2EP05_SW_PATCH_VERSION  11U
 ...
 *
 * Result of the verification of the Data in E2E Profile 5, determined by the Check function.
 */
typedef enum {
 ...
 * \pre Referenced data \a Data is persistent during invocation of E2E_P05Protect
...
/**
 * \brief Check the received Data using the E2E Profile 5.
 *
 ...
 * \pre Referenced data \a Data is persistent during invocation of E2E_P05Check
 *      (i.e. data does not change)
 * \pre Parameter Config is a valid Pointer
 * \pre Parameter State is a valid Pointer
 * \pre Parameter Data is a valid Pointer
 ...
 * the State to E2E_P05STATUS_ERROR.
 *
 * \param[out] StatePtr  Pointer to port/data communication state.
 *
 * \return Function execution success status
...
/**
 * \brief Maps the check status of Profile 5 to a generic check status.
 *
 ...
 * The E2E Profile 5 delivers a more fine-granular status, but this is not relevant
 * for the E2E state machine.
 *
 * \param[in] CheckReturn  Return value of the E2E_P05Check function.
 * \param[in] Status  Status determined by E2E_P05Check function.
 *
 * \return Profile-independent status of the reception on one single Data in one cycle.
 * \retval E2E_P_OK CheckReturn is E2E_E_OK and Status is E2E_P05STATUS_OK
 * or E2E_P05STATUS_OKSOMELOST.
 * \retval E2E_P_ERROR CheckReturn is E2E_E_OK and Status is E2E_P05STATUS_ERROR
 * or CheckReturn is different than E2E_E_OK or Status is undefined.
 * \retval E2E_P_REPEATED CheckReturn is E2E_E_OK and Status is E2E_P05STATUS_REPEATED.
 * \retval E2E_P_NONEWDATA CheckReturn is E2E_E_OK and Status is E2E_P05STATUS_NONEWDATA.
