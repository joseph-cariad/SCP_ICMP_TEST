...
FUNC(void, PDUR_CODE) PduR_GateIfTxConfirmationDfDynPyld
(
    PduIdType GPduId
)
{
   ...
   DBG_PDUR_GATEIFTXCONFIRMATIONDFDYNPYLD_ENTRY(GPduId);
   ...
   DBG_PDUR_GATEIFTXCONFIRMATIONDFDYNPYLD_EXIT(GPduId);
}
