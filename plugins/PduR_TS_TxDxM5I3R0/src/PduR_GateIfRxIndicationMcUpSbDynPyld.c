...
FUNC(void, PDUR_CODE) PduR_GateIfRxIndicationMcUpSbDynPyld
(
    PduIdType GPduId,
    P2VAR(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) PduInfoPtr
)
{
   DBG_PDUR_GATEIFRXINDICATIONMCUPSBDYNPYLD_ENTRY(GPduId, PduInfoPtr);
   ...
   DBG_PDUR_GATEIFRXINDICATIONMCUPSBDYNPYLD_EXIT(GPduId, PduInfoPtr);
}
