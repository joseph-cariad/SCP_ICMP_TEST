...
FUNC(void,PDUR_CODE) PduR_GateIfTxConfirmationDfMCoreDynPyld
(
    PduIdType GPduId
)
{
   ...
   DBG_PDUR_GATEIFTXCONFIRMATIONDFMCOREDYNPYLD_ENTRY(GPduId);
   ...
   DBG_PDUR_GATEIFTXCONFIRMATIONDFMCOREDYNPYLD_EXIT(GPduId);
}
