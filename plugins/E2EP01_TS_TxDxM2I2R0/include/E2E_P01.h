...
#if (defined E2EP01_VENDOR_ID) /* to prevent double declaration */
#error E2EP01_VENDOR_ID is already defined
#endif
/** \brief AUTOSAR vendor identification: Elektrobit Automotive GmbH */
#define E2EP01_VENDOR_ID         1U

/*------------------[AUTOSAR release version identification]----------------*/

#if (defined E2EP01_AR_RELEASE_MAJOR_VERSION) /* to prevent double declaration */
#error E2EP01_AR_RELEASE_MAJOR_VERSION already defined
#endif
/** \brief AUTOSAR release major version */
#define E2EP01_AR_RELEASE_MAJOR_VERSION  4U

#if (defined E2EP01_AR_RELEASE_MINOR_VERSION) /* to prevent double declaration */
#error E2EP01_AR_RELEASE_MINOR_VERSION already defined
#endif
/** \brief AUTOSAR release minor version */
#define E2EP01_AR_RELEASE_MINOR_VERSION  2U

#if (defined E2EP01_AR_RELEASE_REVISION_VERSION) /* to prevent double declaration */
#error E2EP01_AR_RELEASE_REVISION_VERSION already defined
#endif
/** \brief AUTOSAR release revision version */
#define E2EP01_AR_RELEASE_REVISION_VERSION  1U

/*------------------[AUTOSAR specification version identification]----------*/

#if (defined E2EP01_AR_MAJOR_VERSION) /* to prevent double declaration */
#error E2EP01_AR_MAJOR_VERSION already defined
#endif
/** \brief AUTOSAR specification major version */
#define E2EP01_AR_MAJOR_VERSION  4U

#if (defined E2EP01_AR_MINOR_VERSION) /* to prevent double declaration */
#error E2EP01_AR_MINOR_VERSION already defined
#endif
/** \brief AUTOSAR specification minor version */
#define E2EP01_AR_MINOR_VERSION  2U

#if (defined E2EP01_AR_PATCH_VERSION) /* to prevent double declaration */
#error E2EP01_AR_PATCH_VERSION already defined
#endif
/** \brief AUTOSAR specification patch version */
#define E2EP01_AR_PATCH_VERSION  1U

/*------------------[AUTOSAR module version identification]------------------*/

#if (defined E2EP01_SW_MAJOR_VERSION) /* to prevent double declaration */
#error E2EP01_SW_MAJOR_VERSION already defined
#endif
/** \brief AUTOSAR module major version */
#define E2EP01_SW_MAJOR_VERSION  2U

#if (defined E2EP01_SW_MINOR_VERSION) /* to prevent double declaration */
#error E2EP01_SW_MINOR_VERSION already defined
#endif
/** \brief AUTOSAR module minor version */
#define E2EP01_SW_MINOR_VERSION  2U

#if (defined E2EP01_SW_PATCH_VERSION) /* to prevent double declaration */
#error E2EP01_SW_PATCH_VERSION already defined
#endif
/** \brief AUTOSAR module patch version */
#define E2EP01_SW_PATCH_VERSION  17U
 ...
 *
 * The Data ID is two bytes long in E2E Profile 1. There are three inclusion modes how
 * the implicit two-byte Data ID is included in the one-byte CRC.
 */
 /* CheckC disabled. E2E_P01DataIDMode must not be renamed to be consistent with E2E Library spec */
 /* CHECK: RULE 505 OFF */
typedef enum {
...
/**
 * \brief Definition of E2E Profile 1 protect state type.
 *
...
/**
 * \brief Definition of E2E Profile 1 check status type.
 *
 * Type-definition for backward-compatibility due to type renaming done in AUTOSAR version 4.2.1.
 *
 */
 ...
 *
 * Protects the array/buffer to be transmitted using the E2E Profile P01.
 ...
 * \pre Referenced data \a Data is persistent during invocation of E2E_P01Protect
 ...
 *
 * Checks the Data received using the E2E Profile P01.
 ...
 * \pre Referenced data \a Data is persistent during invocation of E2E_P01Check
 *      (i.e. data does not change)
 * \pre Parameter Config is a valid Pointer
 * \pre Parameter State is a valid Pointer
 * \pre Parameter Data is a valid Pointer
...
/**
 * \brief Maps the check status of Profile 1 to a generic check status.
 *
 ...
 * The E2E Profile 1 delivers a more fine-granular status, but this is not relevant
 ...
 *         E2E_P01STATUS_OK or E2E_P01STATUS_OKSOMELOST or E2E_P01STATUS_SYNC, or
 *         CheckReturn is E2E_E_OK and profileBehavior is FALSE and Status is
 *         E2E_P01STATUS_OK or E2E_P01STATUS_OKSOMELOST or E2E_P01STATUS_INITIAL.
 * \retval E2E_P_ERROR CheckReturn is E2E_E_OK and Status is E2E_P01STATUS_WRONGCRC, or
 *         CheckReturn is E2E_E_OK and Status is a not defined status, or
 *         CheckReturn does not equal E2E_E_OK.
 * \retval E2E_P_REPEATED CheckReturn is E2E_E_OK and Status is E2E_P01STATUS_REPEATED.
 * \retval E2E_P_NONEWDATA CheckReturn is E2E_E_OK and Status is E2E_P01STATUS_NONEWDATA.
 * \retval E2E_P_WRONGSEQUENCE CheckReturn is E2E_E_OK and profileBehavior is TRUE
 *         and Status is E2E_P01STATUS_WRONGSEQUENCE or E2E_P01STATUS_INITIAL, or
 *         CheckReturn is E2E_E_OK and profileBehavior is FALSE
 *         and Status is E2E_P01STATUS_WRONGSEQUENCE or E2E_P01STATUS_SYNC.
 *
 * \ServiceID{0x1d}
