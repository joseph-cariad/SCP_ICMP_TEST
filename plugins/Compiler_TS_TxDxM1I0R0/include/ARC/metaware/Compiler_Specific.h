 ...
 * The macro _METAWARE_C_ARC_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _METAWARE_C_ARC_ /* to prevent double definition */
/** \brief compiler symbol for ARM compiler for CORTEXM */
/* Deviation MISRAC2012-1 */
#define _METAWARE_C_ARC_
#else
#error _METAWARE_C_ARC_ already defined
#endif /* ifndef _METAWARE_C_ARC_ */
