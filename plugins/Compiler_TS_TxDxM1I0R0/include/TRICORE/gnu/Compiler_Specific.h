 ...
 * The macro _GNU_C_TRICORE_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _GNU_C_TRICORE_ /* to prevent double definition */
/** \brief compiler symbol for Gnu compiler for TRICORE */
/* Deviation MISRAC2012-1 */
#define _GNU_C_TRICORE_
#else
#error _GNU_C_TRICORE_ already defined
#endif /* ifndef _GNU_C_TRICORE_ */
