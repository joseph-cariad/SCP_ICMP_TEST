 ...
 * The macro _GCC_C_CORTEXM_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _GCC_C_CORTEXM_ /* to prevent double definition */
/** \brief compiler symbol for Gnu compiler for CORTEXM */
/* Deviation MISRAC2012-1 */
#define _GCC_C_CORTEXM_
#else
#error _GCC_C_CORTEXM_ already defined
#endif /* ifndef _GCC_C_CORTEXM_ */
