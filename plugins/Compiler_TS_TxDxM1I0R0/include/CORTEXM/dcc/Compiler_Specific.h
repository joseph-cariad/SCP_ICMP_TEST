 ...
 * The macro _DIABDATA_C_PA_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _DIABDATA_C_CORTEXM_ /* to prevent double definition */
/** \brief compiler symbol for DiabData compiler for PA */
/* Deviation MISRAC2012-1 */
#define _DIABDATA_C_CORTEXM_
#else
#error _DIABDATA_C_CORTEXM_ already defined
#endif /* ifndef _DIABDATA_C_PA_ */
