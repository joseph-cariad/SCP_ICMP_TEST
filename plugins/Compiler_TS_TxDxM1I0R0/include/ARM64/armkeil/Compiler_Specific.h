 ...
 * The macro _ARMKEIL_C_ARM64_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _ARMKEIL_C_ARM64_ /* to prevent double definition */
/** \brief compiler symbol for Keil compiler for ARM64 */
/* Deviation MISRAC2012-1 */
#define _ARMKEIL_C_ARM64_
#else
#error _ARMKEIL_C_ARM64_ already defined
#endif /* ifndef _ARMKEIL_C_ARM64_ */
