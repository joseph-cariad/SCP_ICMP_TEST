 ...
 * The macro _GCC_C_ARM64_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _GCC_C_ARM64_ /* to prevent double definition */
/** \brief compiler symbol for Gnu compiler for ARM64 */
/* Deviation MISRAC2012-1 */
#define _GCC_C_ARM64_
#else
#error _GCC_C_ARM64_ already defined
#endif /* ifndef _GCC_C_ARM64_ */
