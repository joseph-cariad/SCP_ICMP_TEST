 ...
 * The macro _GREENHILLS_C_PA_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _GREENHILLS_C_PA_ /* to prevent double definition */
/** \brief compiler symbol for Greenhills compiler for PA */
/* Deviation MISRAC2012-1 */
#define _GREENHILLS_C_PA_
#else
#error _GREENHILLS_C_PA_ already defined
#endif /* ifndef _GREENHILLS_C_PA_ */
