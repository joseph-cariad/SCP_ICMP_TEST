...
#ifndef _DIABDATA_C_ARM_ /* to prevent double definition */
/** \brief compiler symbol for DIAB compiler for ARM*/
/* Deviation MISRAC2012-1 */
#define _DIABDATA_C_ARM_
#else
#error _DIABDATA_C_ARM_ already defined
#endif /* ifndef _DIABDATA_C_ARM_ */
