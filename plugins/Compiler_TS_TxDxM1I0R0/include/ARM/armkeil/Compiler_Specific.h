 ...
 * The macro _ARMKEIL_C_ARM_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _ARMKEIL_C_ARM_ /* to prevent double definition */
/** \brief compiler symbol for KEIL compiler for ARM*/
/* Deviation MISRAC2012-1 */
#define _ARMKEIL_C_ARM_
#else
#error _ARMKEIL_C_ARM_ already defined
#endif /* ifndef _ARMKEIL_C_ARM_ */
