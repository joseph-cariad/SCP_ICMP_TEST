 ...
 * The macro _TEXAS_INSTRUMENTS_C_ARM_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _TEXAS_INSTRUMENTS_C_ARM_ /* to prevent double definition */
/** \brief compiler symbol for TI cgt compiler for ARM */
/* Deviation MISRAC2012-1 */
#define _TEXAS_INSTRUMENTS_C_ARM_
#else
#error _TEXAS_INSTRUMENTS_C_ARM_ already defined
#endif /* ifndef _TEXAS_INSTRUMENTS_C_ARM_ */
