 ...
 ** specific macros.The macro COMPILERCFG_EXTENSION_MCAL_FILE is generated in 
 ** the Compiler_CfgInt.h file based on configuration in Compiler.xdm file.  
 ** If the macro COMPILERCFG_EXTENSION_MCAL_FILE is defined,the EB's Compiler.h
 ** file will include an additional file Compiler_CfgExtMcal.h. This file can
 ** be used to add additional compiler abstraction macros of 3rd-party MCAL 
 ** modules.This feature is used during a platform porting by EB.
 */
