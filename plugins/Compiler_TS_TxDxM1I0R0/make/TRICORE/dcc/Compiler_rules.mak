...
define build-c-file
	...
	$(EB_VERBOSE)$(CC) -Xmake-dependency=4 @$(MAKE_INC) -o $(OBJ_DIR)/$(notdir $(basename $@)).o $<
	...
	$(EB_VERBOSE)if exist $(notdir $(basename $@)).ir $(MV) $(notdir $(basename $@)).ir $(OBJ_DIR)/$(notdir $(basename $@)).ir
endef
