/* WINDOWS-user-incrementcounter.c
 *
 * This file contains the system function OS_UserIncrementCounter().
...
os_int_t OS_UserIncrementCounter(os_int_t p1);


os_int_t OS_UserIncrementCounter(os_int_t p1)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_IncrementCounter, (os_paramtype_t)p1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
