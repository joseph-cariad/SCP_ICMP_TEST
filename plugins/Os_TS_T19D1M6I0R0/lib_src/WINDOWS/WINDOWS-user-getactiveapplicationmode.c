/* WINDOWS-user-getactiveapplicationmode.c
 *
...
os_int_t OS_UserGetActiveApplicationMode(void);


os_int_t OS_UserGetActiveApplicationMode(void)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_GetActiveApplicationMode, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
