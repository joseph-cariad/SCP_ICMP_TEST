...
os_int_t OS_UserIocAddonExt(os_int_t p1, void * p2, void * p3);


os_int_t OS_UserIocAddonExt(os_int_t p1, void * p2, void * p3)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_IocAddonExt, (os_paramtype_t)p1, (os_paramtype_t) p2, (os_paramtype_t) p3, (os_paramtype_t)-1);
}
