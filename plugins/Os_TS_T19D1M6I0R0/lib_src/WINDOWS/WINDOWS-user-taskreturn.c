...
void OS_UserTaskReturn(void);


void OS_UserTaskReturn(void)
{
	(void) OS_WINLINSyscall(OS_SC_TaskReturn, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
