...
os_int_t OS_UserGetIsrId(void);


os_int_t OS_UserGetIsrId(void)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_GetIsrId, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
