...
os_int_t OS_UserSetRelAlarm(os_int_t p1, os_int_t p2, os_int_t p3);


os_int_t OS_UserSetRelAlarm(os_int_t p1, os_int_t p2, os_int_t p3)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_SetRelAlarm, (os_paramtype_t)p1, (os_paramtype_t)p2, (os_paramtype_t)p3, (os_paramtype_t)-1);
}
