/* WINDOWS-user-startos.c
 *
 * This file contains the system function OS_UserStartOs().
...
void OS_UserStartOs(os_int_t p1);


void OS_UserStartOs(os_int_t p1)
{
	(void) OS_WINLINSyscall(OS_SC_StartOs, (os_paramtype_t)p1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
