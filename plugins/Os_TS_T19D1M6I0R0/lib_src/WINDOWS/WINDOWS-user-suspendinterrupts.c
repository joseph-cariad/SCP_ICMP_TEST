/* WINDOWS-user-suspendinterrupts.c
 *
 ...
 *
 * Reason:
 * The recursion is not an issue, because there is plenty of stack space.
 * Furthermore, it's is necessary to achieve the required behavior.
 */
#include <Os_types.h>
...
void OS_UserSuspendInterrupts(os_int_t p1);


/* Deviation MISRA-2 */
void OS_UserSuspendInterrupts(os_int_t p1)
{
	(void) OS_WINLINSyscall(OS_SC_SuspendInterrupts, (os_paramtype_t)p1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
