/* WINDOWS-user-disableinterruptsource.c
 *
...
os_int_t OS_UserDisableInterruptSource(os_int_t p1);


os_int_t OS_UserDisableInterruptSource(os_int_t p1)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_DisableInterruptSource, (os_paramtype_t)p1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
