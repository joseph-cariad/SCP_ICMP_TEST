/* WINDOWS-user-simtimeradvance.c
 *
...
os_int_t OS_UserSimTimerAdvance(os_int_t p1, os_int_t p2);


os_int_t OS_UserSimTimerAdvance(os_int_t p1, os_int_t p2)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_SimTimerAdvance, (os_paramtype_t)p1, (os_paramtype_t)p2, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
