...
os_int_t OS_UserSchedule(void);


os_int_t OS_UserSchedule(void)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_Schedule, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
