/* WINDOWS-user-resumeinterrupts.c
 *
...
void OS_UserResumeInterrupts(os_int_t p1);


/* Deviation MISRA-2 */
void OS_UserResumeInterrupts(os_int_t p1)
{
	(void) OS_WINLINSyscall(OS_SC_ResumeInterrupts, (os_paramtype_t)p1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
