...
os_int_t OS_UserAllowAccess(void);


os_int_t OS_UserAllowAccess(void)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_AllowAccess, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
