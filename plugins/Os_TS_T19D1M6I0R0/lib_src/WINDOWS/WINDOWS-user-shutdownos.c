...
void OS_UserShutdownOs(os_int_t p1);


void OS_UserShutdownOs(os_int_t p1)
{
	(void) OS_WINLINSyscall(OS_SC_ShutdownOs, (os_paramtype_t)p1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
