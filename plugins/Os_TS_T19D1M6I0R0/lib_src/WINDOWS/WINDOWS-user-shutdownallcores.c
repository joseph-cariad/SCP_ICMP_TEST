/* WINDOWS-user-shutdownallcores.c
 *
...
void OS_UserShutdownAllCores(os_int_t p1);


void OS_UserShutdownAllCores(os_int_t p1)
{
	(void) OS_WINLINSyscall(OS_SC_ShutdownAllCores, (os_paramtype_t)p1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
