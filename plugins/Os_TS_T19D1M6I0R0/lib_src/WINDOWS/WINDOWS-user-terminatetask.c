...
os_int_t OS_UserTerminateTask(void);


os_int_t OS_UserTerminateTask(void)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_TerminateTask, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
