/* WINDOWS-user-chainscheduletable.c
 *
...
os_int_t OS_UserChainScheduleTable(os_int_t p1, os_int_t p2);


os_int_t OS_UserChainScheduleTable(os_int_t p1, os_int_t p2)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_ChainScheduleTable, (os_paramtype_t)p1, (os_paramtype_t)p2, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
