...
void OS_UserReturnFromCall(void);


void OS_UserReturnFromCall(void)
{
	(void) OS_WINLINSyscall(OS_SC_ReturnFromCall, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
