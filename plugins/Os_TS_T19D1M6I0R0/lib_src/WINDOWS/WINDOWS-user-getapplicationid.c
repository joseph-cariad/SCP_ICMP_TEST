/* WINDOWS-user-getapplicationid.c
 *
...
os_int_t OS_UserGetApplicationId(void);


os_int_t OS_UserGetApplicationId(void)
{
	return (os_int_t) OS_WINLINSyscall(OS_SC_GetApplicationId, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1, (os_paramtype_t)-1);
}
