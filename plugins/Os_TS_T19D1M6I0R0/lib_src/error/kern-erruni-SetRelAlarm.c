/* kern-erruni-SetRelAlarm.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblSetRelAlarm[10] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_SetRelAlarm =
{
    OS_errtblSetRelAlarm,
    OS_SID_SetRelAlarm,
    10
};
