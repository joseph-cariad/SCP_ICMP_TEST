/* kern-erruni-GetScheduleTableStatus.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblGetScheduleTableStatus[6] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_GetScheduleTableStatus =
{
    OS_errtblGetScheduleTableStatus,
