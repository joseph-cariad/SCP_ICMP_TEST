/* kern-erruni-Schedule.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblSchedule[4] =
{
  {
    OS_E_CALLLEVEL,
...
const os_serviceinfo_t OS_svc_Schedule =
{
    OS_errtblSchedule,
    OS_SID_Schedule,
    4
