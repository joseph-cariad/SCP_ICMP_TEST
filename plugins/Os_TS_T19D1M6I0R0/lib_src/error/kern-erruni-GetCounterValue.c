/* kern-erruni-GetCounterValue.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblGetCounterValue[6] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_GetCounterValue =
{
    OS_errtblGetCounterValue,
