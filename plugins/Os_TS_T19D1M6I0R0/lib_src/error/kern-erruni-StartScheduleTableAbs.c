/* kern-erruni-StartScheduleTableAbs.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblStartScheduleTableAbs[10] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_StartScheduleTableAbs =
{
    OS_errtblStartScheduleTableAbs,
