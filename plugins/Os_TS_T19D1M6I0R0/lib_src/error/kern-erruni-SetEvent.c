/* kern-erruni-SetEvent.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblSetEvent[9] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_SetEvent =
{
    OS_errtblSetEvent,
    OS_SID_SetEvent,
    9
