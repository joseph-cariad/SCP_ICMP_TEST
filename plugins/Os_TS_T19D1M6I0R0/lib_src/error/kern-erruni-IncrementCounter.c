/* kern-erruni-IncrementCounter.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblIncrementCounter[7] =
{
  {
    OS_E_ACCESS,
  ...
  {
    OS_E_ID,
    OS_ERROR_CounterIsHw,
    OS_ACTION_QUARANTINE|OS_ACTION_ERRORHOOK
  }
};

const os_serviceinfo_t OS_svc_IncrementCounter =
{
    OS_errtblIncrementCounter,
