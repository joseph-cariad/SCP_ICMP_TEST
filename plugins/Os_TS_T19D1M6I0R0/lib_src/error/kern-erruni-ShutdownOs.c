/* kern-erruni-ShutdownOs.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblShutdownOs[3] =
{
  {
    OS_E_CALLLEVEL,
...
const os_serviceinfo_t OS_svc_ShutdownOs =
{
    OS_errtblShutdownOs,
    OS_SID_ShutdownOs,
    3
