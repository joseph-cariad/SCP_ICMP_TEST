/* kern-erruni-CheckObjectOwnership.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblCheckObjectOwnership[4] =
{
  {
    OS_E_CALLLEVEL,
...
const os_serviceinfo_t OS_svc_CheckObjectOwnership =
{
    OS_errtblCheckObjectOwnership,
