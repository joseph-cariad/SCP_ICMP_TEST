/* kern-erruni-GetAlarm.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblGetAlarm[8] =
{
  {
    OS_E_CORE,
    OS_ERROR_CoreIsDown,
...
const os_serviceinfo_t OS_svc_GetAlarm =
{
    OS_errtblGetAlarm,
    OS_SID_GetAlarm,
    8
