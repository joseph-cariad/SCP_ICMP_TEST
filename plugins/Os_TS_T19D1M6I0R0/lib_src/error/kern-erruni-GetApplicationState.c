/* kern-erruni-GetApplicationState.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblGetApplicationState[5] =
{
  {
    OS_E_INTDISABLE,
...
const os_serviceinfo_t OS_svc_GetApplicationState =
{
    OS_errtblGetApplicationState,
