/* kern-erruni-SetAbsAlarm.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblSetAbsAlarm[9] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_SetAbsAlarm =
{
    OS_errtblSetAbsAlarm,
    OS_SID_SetAbsAlarm,
    9
};
