/* kern-erruni-GetEvent.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblGetEvent[7] =
{
  {
    OS_E_CORE,
    OS_ERROR_CoreIsDown,
...
const os_serviceinfo_t OS_svc_GetEvent =
{
    OS_errtblGetEvent,
    OS_SID_GetEvent,
    7
