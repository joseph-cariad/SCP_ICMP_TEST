/* kern-erruni-GetIsrId.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblGetIsrId[2] =
{
  {
    OS_E_CALLLEVEL,
...
const os_serviceinfo_t OS_svc_GetIsrId =
{
    OS_errtblGetIsrId,
    OS_SID_GetIsrId,
    2
