/* kern-erruni-GetAlarmBase.c - kernel error database for STATUS=UNIVERSAL
 *
...
static const os_errorentry_t OS_errtblGetAlarmBase[5] =
{
  {
    OS_E_ACCESS,
...
const os_serviceinfo_t OS_svc_GetAlarmBase =
{
    OS_errtblGetAlarmBase,
    OS_SID_GetAlarmBase,
    5
};
