 ...
 *
 * $Id: kern-callshutdownhook.c 29605 2018-12-11 09:28:41Z magu869 $
*/
 ...
 * A conversion shall not be performed from pointer to void into pointer to
 * object.
 *
 * Reason:
 ...
 *
 * Reason:
 * Function OS_CallShutdownHook is called indirectly by OS_Error and OS_ErrorAction.
 ...
 * Reason:
 *  This warning depends on the OS configuration and library optimization.
 *  Depending on whether application shutdown hooks are called directly,
