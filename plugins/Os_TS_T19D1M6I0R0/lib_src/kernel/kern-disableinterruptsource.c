 ...
 *
 * $Id: kern-disableinterruptsource.c 27926 2017-11-21 17:19:25Z mist9353 $
*/
 ...
 *
 * Implements the API DisableInteruptSource() and hence disables the interrupt source of ISR 'i'.
*/
os_result_t OS_KernDisableInterruptSource(os_isrid_t i)
{
	...
	else
	{
		...
		*/
		...
		{
			os_errorresult_t const e = OS_SendDisableInterruptSource(i, isr);
...
<api API="OS_USER">
  <name>OS_UserDisableInterruptSource</name>
  <synopsis>Disable the Specified Interrupt Source </synopsis>
  <syntax>
    os_result_t OS_UserDisableInterruptSource(os_isrid_t)
  </syntax>
  <description>
    <code>OS_UserDisableInterruptSource()</code> disables the specified
    interrupt source.
    </description>
  <availability>
    No restrictions.
