 ...
 *
 * $Id: Os_configuration_c3.c 26302 2017-03-24 08:58:10Z ingi2575 $
*/
...
os_appdynamic_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.appDynamic);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_taskaccounting_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.taskAccounting);
#endif
#include <memmap/Os_mm_var_end.h>
#endif
...
os_taskdynamic_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.taskDynamic);
#endif
#include <memmap/Os_mm_var_end.h>
...
OS_SECTION_PRAGMA(OS_SLAVEPRIOWORD_OBJ_CORE3, .bss.core3.slavePrioWord)
os_clzword_t
		OS_SECTION_ATTRIB_PRE(.bss.core3.slavePrioWord)
		OS_SLAVEPRIOWORD_OBJ_CORE3[OS_NSLAVEWORDS_CORE3]
		OS_SECTION_ATTRIB_POST(.bss.core3.slavePrioWord);
#else
#if (OS_N_CORES == 1)
OS_SECTION_PRAGMA(OS_SLAVEPRIOWORD_OBJ_CORE3, .bss.core3.slavePrioWord)
os_clzword_t
		OS_SECTION_ATTRIB_PRE(.bss.core3.slavePrioWord)
		OS_SLAVEPRIOWORD_OBJ_CORE3[1]
		OS_SECTION_ATTRIB_POST(.bss.core3.slavePrioWord);
#endif
#endif
#include <memmap/Os_mm_var_end.h>
...
#include <memmap/Os_mm_var_begin.h>
#if (OS_NPRIORITYQUEUEDYNAMICS_CORE3 != 0)
OS_SECTION_PRAGMA(OS_priorityQueueDynamic_core3, .bss.core3.priorityQueueDynamic)
static os_priorityqueuedynamic_t
		OS_SECTION_ATTRIB_PRE(.bss.core3.priorityQueueDynamic)
		OS_priorityQueueDynamic_core3[OS_NPRIORITYQUEUEDYNAMICS_CORE3]
		OS_SECTION_ATTRIB_POST(.bss.core3.priorityQueueDynamic);
#endif
#include <memmap/Os_mm_var_end.h>

#include <memmap/Os_mm_var_begin.h>
#if (OS_NPRIORITYSLOTS_CORE3 != 0)
OS_SECTION_PRAGMA(OS_PRIORITYSLOT_OBJ_CORE3, .bss.core3.prioritySlot)
os_priorityqueueentry_t
		OS_SECTION_ATTRIB_PRE(.bss.core3.prioritySlot)
		OS_PRIORITYSLOT_OBJ_CORE3[OS_NPRIORITYSLOTS_CORE3]
		OS_SECTION_ATTRIB_POST(.bss.core3.prioritySlot);
#else
#if (OS_N_CORES == 1)
OS_SECTION_PRAGMA(OS_PRIORITYSLOT_OBJ_CORE3, .bss.core3.prioritySlot)
os_priorityqueueentry_t
		OS_SECTION_ATTRIB_PRE(.bss.core3.prioritySlot)
		OS_PRIORITYSLOT_OBJ_CORE3[1]
		OS_SECTION_ATTRIB_POST(.bss.core3.prioritySlot);
#endif
#endif
#include <memmap/Os_mm_var_end.h>
...
os_priorityqueue_t const OS_PRIORITYQUEUE_OBJ_CORE3[OS_NPRIORITIES_CORE3] = { OS_PRIORITYQUEUE_INIT_CORE3 };
#else
#if (OS_N_CORES == 1)
os_priorityqueue_t const OS_PRIORITYQUEUE_OBJ_CORE3[1] = { {OS_NULL, OS_NULL, OS_NULL, 0, 0, 0} };
#endif
#endif
...
os_tasklink_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.taskActivations);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_resourcedynamic_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.resourceDynamic);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_israccounting_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.isrAccounting);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_isrdynamic_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.isrDynamic);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_rateindex_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.rateIndex);
#endif
...
os_timestamp_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.rateTimer);
#endif
#include <memmap/Os_mm_var_end.h>
...
#include <memmap/Os_mm_var_begin.h>
static
OS_SECTION_PRAGMA(OS_cpuLoad_core3, .bss.core3.cpuLoad)
os_cpuload_t
		OS_SECTION_ATTRIB_PRE(.bss.core3.cpuLoad)
		OS_cpuLoad_core3
		OS_SECTION_ATTRIB_POST(.bss.core3.cpuLoad);
#include <memmap/Os_mm_var_end.h>

/*!
 * OS_cpuLoadBusyBuffer_core3
 *
 ...
 */
#include <memmap/Os_mm_var_begin.h>
OS_SECTION_PRAGMA(OS_cpuLoadBusyBuffer_core3, .bss.core3.cpuLoadBusyBuffer)
os_tick_t
		OS_SECTION_ATTRIB_PRE(.bss.core3.cpuLoadBusyBuffer)
		OS_cpuLoadBusyBuffer_core3[OS_CPULOADCFG_NINTERVALS]
		OS_SECTION_ATTRIB_POST(.bss.core3.cpuLoadBusyBuffer);
#include <memmap/Os_mm_var_end.h>
...
os_messagequeue_t
		...
		OS_SECTION_ATTRIB_POST(.bss.shared.core3.messageQueue);
#include <memmap/Os_mm_var_end.h>
#endif /* OS_N_CORES > 1 */
...
os_kerneldata_t
		...
		OS_SECTION_ATTRIB_POST(.data.core3.kernelData) = { OS_KERNELDATA_INIT_CORE3 };
#include <memmap/Os_mm_var_end.h>
...
os_counterdynamic_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.counterDynamic);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_alarmdynamic_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.alarmDynamic);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_scheduledynamic_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.scheduleDynamic);
#endif
#include <memmap/Os_mm_var_end.h>
...
os_timervalue_t
		...
		OS_SECTION_ATTRIB_POST(.bss.core3.hwtLastValue);
#include <memmap/Os_mm_var_end.h>
#endif
...
volatile os_panic_t
		...
		OS_panicCode_core3
		OS_SECTION_ATTRIB_POST(.bss.core3.panicCode);
#include <memmap/Os_mm_var_end.h>
