...
#ifndef CRYPTO_XVIX_XAIX_AL_RSASSAPKCS1V15VRFY_H
#define CRYPTO_XVIX_XAIX_AL_RSASSAPKCS1V15VRFY_H
...
Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Start
(
  uint32                                                       ObjectId,
 ...
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_APPL_CODE)
Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Update
(
  uint32                                                         ObjectId,
 ...
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_APPL_CODE)
Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Finish
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);
 ...
 *
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_Cancel
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);

/** \brief Perform the RSASSA-PKCS1-v1_5 verify tasks.
 *
 ...
 *
 */
extern FUNC(void, CRYPTO_xVIx_xAIx_APPL_CODE)
Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_RSA_RSASSA_PKCS1_v1_5_MainFunction
(
...
#endif /* #if(STD_ON == CRYPTO_XVIX_XAIX_RSAPKCS_VRFY_ENABLED) */

#endif /* CRYPTO_XVIX_XAIX_AL_RSASSAPKCS1V15VRFY_H */
