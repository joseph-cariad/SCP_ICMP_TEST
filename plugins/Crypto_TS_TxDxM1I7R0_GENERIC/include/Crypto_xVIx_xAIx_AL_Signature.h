...
#ifndef CRYPTO_XVIX_XAIX_AL_SIGNATURE_H
#define CRYPTO_XVIX_XAIX_AL_SIGNATURE_H
...
#if ((CRYPTO_XVIX_XAIX_EDDSA_GEN_ENABLED == STD_ON)||(CRYPTO_XVIX_XAIX_EDDSA_VRFY_ENABLED == STD_ON))
 ...
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREGENERATE_ED25519_NOT_SET_Start
(
  uint32                                                       ObjectId,
 ...
 * \retval E_NOT_OK       If no EdDSA computation has been started via Crypto_xVIx_xAIx_EdDSAStart(), yet
 *
 * \Reentrancy{Nonreentrant}
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREGENERATE_ED25519_NOT_SET_Update
(
  uint32                                                         ObjectId,
 ...
 * \retval CRYPTO_E_BUSY  If the main function is processing a requested service at the moment
 * \retval _E_NOT_OK      If no EdDSA computation has been started via Crypto_xVIx_xAIx_EdDSAStart(), yet.
 *
 * \Reentrancy{Nonreentrant}
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREGENERATE_ED25519_NOT_SET_Finish
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);
 ...
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREGENERATE_ED25519_NOT_SET_Cancel
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);
 ...
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(void, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREGENERATE_ED25519_NOT_SET_MainFunction
(
 ...
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_ED25519_NOT_SET_Start
(
  uint32                                                       ObjectId,
  P2VAR(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);
 ...
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_ED25519_NOT_SET_Update
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);
 ...
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_ED25519_NOT_SET_Finish
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);
 ...
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_ED25519_NOT_SET_Cancel
(
  uint32                                                         ObjectId,
  P2CONST(Crypto_JobType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Job
);
 ...
 * \Synchronicity{Synchronous/Asynchronous}
 */
extern FUNC(void, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_AL_SIGNATUREVERIFY_ED25519_NOT_SET_MainFunction
(
  P2VAR(Std_ReturnType,AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) Result,
  P2VAR(boolean,AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA)        Busy
);
...
#endif /*#if ((CRYPTO_XVIX_XAIX_EDC_ENABLED == STD_ON)||(CRYPTO_XVIX_XAIX_EDDSA_GEN_ENABLED == STD_ON)||
         (CRYPTO_XVIX_XAIX_EDDSA_VRFY_ENABLED == STD_ON))*/

#endif /* #ifndef CRYPTO_XVIX_XAIX_AL_SIGNATURE_H */
